...
public class InGameDocumentTextAndImage : MonoBehaviour
{
    ...
    public void setTextAndImage(string textKey, string imageKey, LanguageManager langManager, bool hasDialogAfter, List<string> imageList, string dialogKey, bool isCollectable, string itemID)
    {
